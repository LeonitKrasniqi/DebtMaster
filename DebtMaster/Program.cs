...
{
    options.SwaggerDoc("v1", new OpenApiInfo { Title = "DebtMasterAPI", Version = "v1" });
...
builder.Services
    ...
    .AddTokenProvider<DataProtectorTokenProvider<IdentityUser>>("DebtMaster")
    .AddEntityFrameworkStores<DebtAuthDbContext>()
